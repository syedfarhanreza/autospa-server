...
const { createSlot, getAllAvailableSlotsService, getSlotByIdService, getAllSlotsService, toggleSlotsStatusService, } = slot_service_1.default;
...
exports.toggleSlotStatus = (0, catchAsyncError_1.catchAsyncError)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield toggleSlotsStatusService(req.params.id);
    if (!result) {
        return (0, sendResponse_1.default)(res, {
            data: null,
            success: false,
